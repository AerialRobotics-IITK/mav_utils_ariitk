...
rospy.init_node('pose_to_odom_avg')

vicon_sub = rospy.Subscriber('/f450/arcuo_single_ideal/pose', PoseStamped, vicon_cb, queue_size=100)
odom_pub = rospy.Publisher('/avg_odom', Odometry, queue_size=100)
...
while not rospy.is_shutdown():
	...
	if counter > 0:
		...
		br.sendTransform((x,y,z),[pose.pose.orientation.x, pose.pose.orientation.y,pose.pose.orientation.z,pose.pose.orientation.w],rospy.Time.now(), "/f450/base_link","/world")
